...
const App = DrawerNavigator({
  ...
  ForgotPassword: {
    screen: props => <ForgotPassword {...props.screenProps} onCancel={() => props.navigation.navigate('Home')} onSuccess={() => props.navigation.navigate('Home')} />,
    navigationOptions: { drawerLabel: 'Change password' },
  },
  SignOut: {
    screen: props => <SignOut rootNavigator={props.navigation} {...props} />,
